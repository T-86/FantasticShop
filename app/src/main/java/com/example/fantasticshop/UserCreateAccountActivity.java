...
public class UserCreateAccountActivity extends AppCompatActivity {
    ...
    public Boolean passwordValidation() {
        ...
        if (password.isEmpty()) {
            ...
            userAccountEmail.setError("Wrong password, must be at least 6 characters that contains:" +
            ...
            userAccountEmail.setError("confirmed password does not matches, please check your password");
        userAccountEmail.setText(""); return false;
        } else {
            userAccountEmail.setError(null);
            return true;
        }
